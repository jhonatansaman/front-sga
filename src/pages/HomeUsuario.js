...
class HomeUsuario extends Component {
    ...
    async componentDidMount() {
        ...
        if(data==1635680)
            await this.setState({ tipoUsuario: true })
        else
            await this.setState({ tipoUsuario: false })   
        
        console.log("tipo usuário: ", this.state.tipoUsuario);
        ...
        console.log("responsebuscar: ", response.data);
